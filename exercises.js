...
function chartBuster(arr){
for(var i = 0; i<arr.length; i++){
   console.log("This week's chart buster is: " + arr[i]);
 }
 
}
console.log(chartBuster(topFive));
...
function leaders(arr){
   for(var i = 0; i<arr.length; i++){
      console.log('The value at ' + i + ' is: ' + arr[i]);
    }
...
for(var i = oopsArray.length - 1; i >= 0; i --){ // use minus 1 to start at the END of array
...
function capFirstLett(str){
   var splitOrigStr = str.split(" ");
   //console.log(splitOrigStr);
